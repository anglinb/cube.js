...
Following Cube Cloud's GA last month, we've been hard at work making
improvements across the board. Let's have a quick run through them:
...
deployment and then switch between them, just click the branch name in the
status bar:
...
- Automatically switch to Developer Mode to the Rollup Designer when adding
  rollups
